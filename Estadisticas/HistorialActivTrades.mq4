...
int OnInit()
{
   // IMPORTANTE: Mostrar advertencia sobre el filtro de historial
   Print("========================================");
   Print("IMPORTANTE: Asegurate de tener seleccionado 'Todo el historial'");
   Print("en la pestana 'Historial de Cuenta' (clic derecho -> All History)");
   Print("De lo contrario solo se exportaran las ordenes visibles.");
   Print("========================================");
   ...
   Print("Exportacion finalizada. Puede remover el EA del grafico.");
